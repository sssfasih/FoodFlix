# Generated by Django 3.1.7 on 2021-04-11 14:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Directions', models.CharField(max_length=9999)),
                ...
                ('Tags', models.ManyToManyField(blank=True, related_name='recipes', to='recipes.Category')),
            ],
        ),
        migrations.CreateModel(
            name='RecipeImage',
